...
include_once(ALBUM_INCLUDES_PATH . 'functions.' . PHP_EXT);
include_once(ALBUM_INCLUDES_PATH . 'functions_otf.' . PHP_EXT);
include_once(ALBUM_INCLUDES_PATH . 'hierarchy_functions.' . PHP_EXT);
require(IP_ROOT_PATH . 'includes/class_image.' . PHP_EXT);


setup_extra_lang(array('lang_album_main', 'lang_album_admin'), ALBUM_ROOT_PATH . 'language/');
