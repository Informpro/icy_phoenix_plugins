...
{
	message_die(GENERAL_ERROR, 'Could not find the needed defines<br />Has they been implemented in ' . ALBUM_INCLUDES_PATH . 'album_constants.' . PHP_EXT . ' ?', '', __LINE__, __FILE__);
}
...
require_once(ALBUM_INCLUDES_PATH . 'album_hierarchy_debug.' . PHP_EXT);
require_once(ALBUM_INCLUDES_PATH . 'album_hierarchy_auth.' . PHP_EXT);
require_once(ALBUM_INCLUDES_PATH . 'album_hierarchy_sql.' . PHP_EXT);
