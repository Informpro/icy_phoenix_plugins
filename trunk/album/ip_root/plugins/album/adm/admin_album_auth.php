...
if(!isset($_POST['submit']))
{
	...
	$template->set_filenames(array('body' => ALBUM_ADM_TPL_PATH . 'album_cat_select_body.tpl'));
...
else
{
	if(!isset($_GET['cat_id']))
	{
		...
		$template->set_filenames(array('body' => ALBUM_ADM_TPL_PATH . 'album_auth_body.tpl'));
