...
require_once(ALBUM_INCLUDES_PATH . 'acp_functions.' . PHP_EXT);
...
if(!isset($_POST['mode']))
{
	...
	else
	{
		...
		elseif($_GET['action'] == 'delete')
		{
			...
			$template->set_filenames(array('body' => ALBUM_ADM_TPL_PATH . 'album_cat_delete_body.tpl'));
...
else
{
	if($_POST['mode'] == 'new')
	{
		...
		if(!isset($_POST['cat_title']))
		{
			...
			$template->set_filenames(array('body' => ALBUM_ADM_TPL_PATH . 'album_cat_new_body.tpl'));
